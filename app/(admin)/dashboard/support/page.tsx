...
export default function SupportPage(){
  ...
  return <div className="w-full space-y-5 px-4 py-5"><PageHeader title="Support Operations" description="Review account deletion requests with identity and cooling-off controls."/>
