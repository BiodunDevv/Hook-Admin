...
export default function CommercialCatalogPage() {
  ...
  return <div className="p-2 md:p-4"><PageHeader title="Commercial Catalog" description="Complete customer content, approve pricing, configure negotiation, and publish." />
