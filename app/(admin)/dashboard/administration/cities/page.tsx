...
export default function CitiesPage() {
  return (
    <PlatformDirectoryPage
      title="Operation Cities"
      description="Manage cities inside configured states."
      endpoint="/admin/cities"
      detailBase="/dashboard/administration/cities"
      permissionLabel="city administration"
      managePermission="cities.manage"
      lifecyclePermission="cities.manage"
      lifecyclePaths={{ activate: "activate", deactivate: "deactivate" }}
      fields={[
        { key: "name", label: "City name", required: true },
        { key: "code", label: "City code", required: true },
        {
          key: "stateId",
