...
export default function StatesPage() {
  return (
    <PlatformDirectoryPage
      ...
      description="Manage state-level Hook configuration."
      endpoint="/admin/states"
      detailBase="/dashboard/administration/states"
      permissionLabel="state administration"
      managePermission="states.manage"
      lifecyclePermission="states.manage"
      ...
      columns={[
        ...
        { key: "code", label: "Code" },
        { key: "deliveryPromiseHours", label: "Promise hours" },
      ]}
    />
  );
}
